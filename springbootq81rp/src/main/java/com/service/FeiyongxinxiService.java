...
public interface FeiyongxinxiService extends IService<FeiyongxinxiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<FeiyongxinxiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<FeiyongxinxiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<FeiyongxinxiEntity> wrapper);
