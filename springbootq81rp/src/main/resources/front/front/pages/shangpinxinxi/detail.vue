...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"160rpx 0 132rpx","position":"relative","background":"url(http://codegen.caihongy.cn/20221222/748292afaf1a42f98ea39cb94757b451.png) no-repeat center top / 100% auto,url(http://codegen.caihongy.cn/20221222/c6ef4a2042384649921c28b8b4f18cac.png) fixed repeat-y center bottom","height":"auto"}'>
						<swiper :style='{"border":"0px dotted #f7de91","boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"0px 0 0px ","margin":"0px auto","borderColor":"#333","borderRadius":"24rpx","background":"rgba(255,255,255,.6)","borderWidth":"2rpx","width":"calc(100% - 40rpx)","borderStyle":"solid","height":"396rpx"}' class="swiper" :indicator-dots='false' :autoplay='true' :circular='false' indicator-active-color='#000000' indicator-color='rgba(0, 0, 0, .3)' :duration='500' :interval='5000' :vertical='false'>
				...
				<view :style='{"padding":"0px 20rpx 0px","boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","margin":"40rpx 0 24rpx 0","borderColor":"#e9be70","borderRadius":"24rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="detail-list-item price priceFavor">
					...
					<view :style='{"border":"2rpx solid #e9be70","boxShadow":"inset 0px 40rpx 64rpx 0px #fff","margin":"6rpx 12rpx 0","color":"#fec55d","borderRadius":"100%","textAlign":"center","background":"none","display":"block","width":"64rpx","lineHeight":"64rpx","fontSize":"48rpx","height":"64rpx"}' v-if="storeupFlag==1" class="cuIcon-favorfill" @click="shoucang"></view>
					<view :style='{"border":"2rpx solid #e9be70","boxShadow":"inset 0px 40rpx 64rpx 0px #fff","margin":"6rpx 12rpx 0","color":"#fec55d","borderRadius":"100%","textAlign":"center","background":"none","display":"block","width":"64rpx","lineHeight":"64rpx","fontSize":"48rpx","height":"64rpx"}' v-if="storeupFlag==0" class="cuIcon-favor" @click="shoucang"></view>
				</view>

				<view :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
				...
				<view :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"188rpx","lineHeight":"80rpx","fontSize":"28rpx","minWidth":"188rpx"}' class="lable">商品类型：</view>
					<view :style='{"padding":"0px 20rpx 20rpx 0","margin":"16rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text">{{detail.shangpinleixing}}</view>
				</view>
				<view :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"188rpx","lineHeight":"80rpx","fontSize":"28rpx","minWidth":"188rpx"}' class="lable">商品规格：</view>
					<view :style='{"padding":"0px 20rpx 20rpx 0","margin":"16rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text">{{detail.shangpinguige}}</view>
				</view>

				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"188rpx","lineHeight":"80rpx","fontSize":"28rpx","minWidth":"188rpx"}'>生产地：</view>
					<view  class="text" :style='{"padding":"0px 20rpx 20rpx 0","margin":"16rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.shengchandi}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"188rpx","lineHeight":"80rpx","fontSize":"28rpx","minWidth":"188rpx"}'>原材料：</view>
					<view  class="text" :style='{"padding":"0px 20rpx 20rpx 0","margin":"16rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.yuancailiao}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"0 0 8rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"right","width":"188rpx","lineHeight":"80rpx","fontSize":"28rpx","minWidth":"188rpx"}'>商品简介</view>
					<view class="text" :style='{"padding":"0px 20rpx 20rpx 0","margin":"16rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.shangpinjianjie}}</view>
				</view>


				<view class="detail-list-item rich" :style='{"boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","padding":"24rpx 24rpx","margin":"0 0 24rpx 0","borderColor":"#e9be70","borderRadius":"40rpx","borderWidth":"2rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="time-content" :style='{"width":"100%","margin":"0 0 24rpx 0","height":"auto"}'>
					<view class="comoment-header" :style='{"border":"0px solid #fdd802","boxShadow":"inset 0px 0px 0px 0px #fcf3bf","padding":"0px 20rpx","margin":"0px","borderRadius":"40rpx","background":"linear-gradient(-225deg, rgba(255,186,195,.6) 0%, rgba(197,193,255,.9) 56%, rgba(180,146,220,.96) 100%)","display":"flex","width":"calc(100% + 0px)","justifyContent":"space-between","height":"auto"}'>
					...
					<view :style='{"padding":"24rpx 24rpx 40rpx","boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","margin":"32rpx 0 32rpx","borderColor":"#e9be70","borderRadius":"40rpx","background":"url() repeat-x left bottom,rgba(255,255,255,.6)","borderWidth":"2rpx","width":"100%","borderStyle":"solid","height":"auto"}' v-for="(item,index) in commentList" v-bind:key="index" class="cu-item comment-item">
