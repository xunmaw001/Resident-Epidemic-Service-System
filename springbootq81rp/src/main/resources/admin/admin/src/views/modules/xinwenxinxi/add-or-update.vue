	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="新闻分类" prop="xinwenfenlei">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="主编" prop="zhubian">
					<el-input v-model="ruleForm.zhubian" placeholder="主编" clearable  :readonly="ro.zhubian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="主编" prop="zhubian">
					<el-input v-model="ruleForm.zhubian" placeholder="主编" readonly></el-input>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				zhubian: [
					{ required: true, message: '主编不能为空', trigger: 'blur' },
				],
				jianjie: [
				],
				xiangqing: [
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springbootq81rp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
