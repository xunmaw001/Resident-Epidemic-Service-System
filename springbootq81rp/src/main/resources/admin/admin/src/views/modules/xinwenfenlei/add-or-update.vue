<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="新闻分类" prop="xinwenfenlei">
					<el-input v-model="ruleForm.xinwenfenlei" placeholder="新闻分类" clearable  :readonly="ro.xinwenfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="新闻分类" prop="xinwenfenlei">
